...
export const encriptarDatoConIVFijo = (req, res) => {
    try {
        ...
        return res.status(500).json({ error: 'Error en la encriptación', message: error.message });
    }
};
...
export const desencriptarDatoConIVFijo = (req, res) => {
    try {
        ...
        return res.status(500).json({ error: 'Error en la desencriptación', message: error.message });
    }
};
